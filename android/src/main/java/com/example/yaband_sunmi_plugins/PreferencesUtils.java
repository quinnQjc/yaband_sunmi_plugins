...
public class PreferencesUtils {
    ...
    public static String PREFERENCE_NAME = "YaBandPay";
...
//        获取收银员 entity
//     */
//    public static AllMerchantEntity.DataBean.YcashierListBean getCashierEntity(Context context) {
//        try {
//            AllMerchantEntity.DataBean.YcashierListBean cashierEntity = JSON.parseObject(getString(context, "CashierEntity"), AllMerchantEntity.DataBean.YcashierListBean.class);
//            if (cashierEntity != null) {
//                return cashierEntity;
//            }
//        } catch (Exception e) {
//            Log.e("PerferencesUtils", "JSON.parseObject: getCashierEntity ERROR", e);
//        }
//        return null;
//    }
